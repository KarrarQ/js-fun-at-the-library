...
// book (made up or not!). Your sequel must make use of your "title" variable from abovevar



var sequel = title + ' sequel The Subtle Knife, is out now.';
...
if ( isFavorite === true) {
  console.log(`My favorite book is ${'The Golden Compass'}!`)
} else {
  console.log(`I recently read ${'The Golden Compass'} book`)
};
...
books.belowTwoHundred = [1,2,3,4,5,6,7,8,9,99,11,22];


// Write the code to access the 5th element of the array, using bracket notation.
console.log(books.belowTwoHundred[5]);
